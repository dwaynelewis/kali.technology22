...
editableItems['span.fa, i.fa'] = ['color', 'font-size'];
editableItems['.bg.bg1, .inner-content', '.bgCol'] = ['background-color'];
...
editableItems['a.btn, button.btn, .button'] = ['border-radius', 'font-size', 'background-color'];
...
editableItems['.bg.bg1, .parallax-bg3, .bg.bg2, .header10, .header11'] = ['background-image', 'background-color'];
editableItems['img.edit'] = [];
...
var editableContent = ['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'li a', 'span', 'small', 'em', '.editContent', '.navbar a', 'button', '.button', 'a.btn', '.footer a:not(.fa)', '.tableWrapper', '.c-info li', 'tr th', 'tr td'];
